...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        path("/metodo", () -> {
            post("/insert", (request, response) -> metodosEstudosService.insertMetodo(request, response));
            get("/catch", (request, response) -> {
                ArrayList<MetodosEstudos> T = metodosEstudosService.listAllMethods(request, response);

                Map<String, Object> data = new HashMap<>(); 
                data.put("metodosEstudo", T);
    
                Template template = cfg.getTemplate("metodos.ftl");
